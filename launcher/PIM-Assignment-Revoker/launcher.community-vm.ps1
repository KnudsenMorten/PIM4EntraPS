...
<#
.SYNOPSIS
    Community VM launcher for PIM4EntraPS\PIM-Assignment-Revoker. Invokes the engine
...
.DESCRIPTION
    Runs PIM4EntraPS\PIM-Assignment-Revoker on a Windows box in the customer's own tenant.
...
if (-not (Test-Path -LiteralPath $engine)) {
    throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Assignment-Revoker\PIM-Assignment-Revoker.ps1."
}
& $engine
