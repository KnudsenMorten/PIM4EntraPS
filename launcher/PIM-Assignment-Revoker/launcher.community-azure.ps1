...
$engine = Join-Path $solutionRoot 'engine\PIM-Assignment-Revoker\PIM-Assignment-Revoker.ps1'
if (-not (Test-Path -LiteralPath $engine)) { throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Assignment-Revoker\PIM-Assignment-Revoker.ps1." }
& $engine
