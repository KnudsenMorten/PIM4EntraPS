...
<#
.SYNOPSIS
    Community cloud-native launcher for PIM4EntraPS\Fix_PIM_MFA_Auth_Policy.
.DESCRIPTION
...
Write-PlatformLog -Context $ctx -Event 'engine.start' -Message 'Fix_PIM_MFA_Auth_Policy (community cloud) starting'
...
try {
    ...
    & $engine
    Write-PlatformLog -Context $ctx -Event 'engine.end' -Message 'Fix_PIM_MFA_Auth_Policy (community cloud) completed'
}
catch {
