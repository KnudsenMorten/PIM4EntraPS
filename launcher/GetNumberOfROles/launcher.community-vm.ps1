...
<#
.SYNOPSIS
    Community VM launcher for PIM4EntraPS\GetNumberOfROles. Invokes the engine
...
.DESCRIPTION
    Runs PIM4EntraPS\GetNumberOfROles on a Windows box in the customer's own tenant.
...
if (-not (Test-Path -LiteralPath $engine)) {
    throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\GetNumberOfROles\GetNumberOfROles.ps1."
}
& $engine
