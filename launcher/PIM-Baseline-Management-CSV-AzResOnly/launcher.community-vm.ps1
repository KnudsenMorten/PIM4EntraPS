...
<#
.SYNOPSIS
    Community VM launcher for PIM4EntraPS\PIM-Baseline-Management-CSV-AzResOnly. Invokes the engine
...
.DESCRIPTION
    Runs PIM4EntraPS\PIM-Baseline-Management-CSV-AzResOnly on a Windows box in the customer's own tenant.
...
.NOTES
    ...
    Engine         : PIM-Baseline-Management-CSV-AzResOnly
...
if (-not (Test-Path -LiteralPath $engine)) {
    throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Baseline-Management-CSV-AzResOnly\PIM-Baseline-Management-CSV-AzResOnly.ps1."
}
& $engine
