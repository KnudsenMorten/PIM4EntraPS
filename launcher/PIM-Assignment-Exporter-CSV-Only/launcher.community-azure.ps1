...
$engine = Join-Path $solutionRoot 'engine\PIM-Assignment-Exporter-CSV-Only\PIM-Assignment-Exporter-CSV-Only.ps1'
if (-not (Test-Path -LiteralPath $engine)) { throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Assignment-Exporter-CSV-Only\PIM-Assignment-Exporter-CSV-Only.ps1." }
& $engine
