...
<#
.SYNOPSIS
    Community cloud-native launcher for PIM4EntraPS\SQL-Connect.
.DESCRIPTION
...
Write-PlatformLog -Context $ctx -Event 'engine.start' -Message 'SQL-Connect (community cloud) starting'
...
try {
    ...
    & $engine
    Write-PlatformLog -Context $ctx -Event 'engine.end' -Message 'SQL-Connect (community cloud) completed'
}
catch {
