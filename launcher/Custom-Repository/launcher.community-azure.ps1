...
<#
.SYNOPSIS
    Community cloud-native launcher for PIM4EntraPS\Custom-Repository.
.DESCRIPTION
...
Write-PlatformLog -Context $ctx -Event 'engine.start' -Message 'Custom-Repository (community cloud) starting'
...
try {
    ...
    & $engine
    Write-PlatformLog -Context $ctx -Event 'engine.end' -Message 'Custom-Repository (community cloud) completed'
}
catch {
