...
<#
.SYNOPSIS
    Community cloud-native launcher for PIM4EntraPS\PIM-extra.
.DESCRIPTION
...
Write-PlatformLog -Context $ctx -Event 'engine.start' -Message 'PIM-extra (community cloud) starting'
...
try {
    ...
    & $engine
    Write-PlatformLog -Context $ctx -Event 'engine.end' -Message 'PIM-extra (community cloud) completed'
}
catch {
