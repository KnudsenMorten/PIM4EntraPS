...
<#
.SYNOPSIS
    Community VM launcher for PIM4EntraPS\PIM-SQL-import-export-CSV. Invokes the engine
...
.DESCRIPTION
    Runs PIM4EntraPS\PIM-SQL-import-export-CSV on a Windows box in the customer's own tenant.
...
.NOTES
    ...
    Engine         : PIM-SQL-import-export-CSV
...
$engine = Join-Path $solutionRoot 'engine\PIM-SQL-import-export-CSV\PIM-SQL-import-export-CSV.ps1'
if (-not (Test-Path -LiteralPath $engine)) {
    throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-SQL-import-export-CSV\PIM-SQL-import-export-CSV.ps1."
}
& $engine
