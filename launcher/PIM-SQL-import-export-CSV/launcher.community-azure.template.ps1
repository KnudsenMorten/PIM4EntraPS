...
<#
.SYNOPSIS
    Community cloud-native launcher for PIM4EntraPS\PIM-SQL-import-export-CSV.
.DESCRIPTION
...
Write-PlatformLog -Context $ctx -Event 'engine.start' -Message 'PIM-SQL-import-export-CSV (community cloud) starting'
...
try {
    ...
    & $engine
    Write-PlatformLog -Context $ctx -Event 'engine.end' -Message 'PIM-SQL-import-export-CSV (community cloud) completed'
}
catch {
