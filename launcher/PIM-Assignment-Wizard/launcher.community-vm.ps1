...
<#
.SYNOPSIS
    Community VM launcher for PIM4EntraPS\PIM-Assignment-Wizard. Invokes the engine
...
.DESCRIPTION
    Runs PIM4EntraPS\PIM-Assignment-Wizard on a Windows box in the customer's own tenant.
