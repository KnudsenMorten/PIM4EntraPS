...
<#
.SYNOPSIS
    Community cloud-native launcher for PIM4EntraPS\Custom-Policies.
.DESCRIPTION
...
Write-PlatformLog -Context $ctx -Event 'engine.start' -Message 'Custom-Policies (community cloud) starting'
...
try {
    ...
    & $engine
    Write-PlatformLog -Context $ctx -Event 'engine.end' -Message 'Custom-Policies (community cloud) completed'
}
catch {
