...
$engine = Join-Path $solutionRoot 'engine\PIM-Baseline-Management-SQL\PIM-Baseline-Management-SQL.ps1'
if (-not (Test-Path -LiteralPath $engine)) { throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Baseline-Management-SQL\PIM-Baseline-Management-SQL.ps1." }
& $engine
