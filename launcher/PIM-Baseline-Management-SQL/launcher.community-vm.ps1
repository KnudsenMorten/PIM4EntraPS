...
<#
.SYNOPSIS
    Community VM launcher for PIM4EntraPS\PIM-Baseline-Management-SQL. Invokes the engine
...
.DESCRIPTION
    Runs PIM4EntraPS\PIM-Baseline-Management-SQL on a Windows box in the customer's own tenant.
...
.NOTES
    ...
    Engine         : PIM-Baseline-Management-SQL
...
if (-not (Test-Path -LiteralPath $engine)) {
    throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Baseline-Management-SQL\PIM-Baseline-Management-SQL.ps1."
}
& $engine
