...
<#
.SYNOPSIS
    Community cloud-native launcher for PIM4EntraPS\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly.
.DESCRIPTION
...
Write-PlatformLog -Context $ctx -Event 'engine.start' -Message 'PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly (community cloud) starting'
...
$engine = Join-Path $solutionRoot 'engine\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly.ps1'
if (-not (Test-Path -LiteralPath $engine)) { throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly.ps1." }
& $engine
    Write-PlatformLog -Context $ctx -Event 'engine.end' -Message 'PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly (community cloud) completed'
}
catch {
