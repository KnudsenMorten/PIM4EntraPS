...
<#
.SYNOPSIS
    Community VM launcher for PIM4EntraPS\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly. Invokes the engine
...
.DESCRIPTION
    Runs PIM4EntraPS\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly on a Windows box in the customer's own tenant.
...
.NOTES
    ...
    Engine         : PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly
...
if (-not (Test-Path -LiteralPath $engine)) {
    throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly\PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly.ps1."
}
& $engine
