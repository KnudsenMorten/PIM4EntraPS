...
if (-not (Test-Path -LiteralPath $engine)) { throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Baseline-Management-CSV-AdministrativeUnitsOnly\PIM-Baseline-Management-CSV-AdministrativeUnitsOnly.ps1." }
& $engine
