...
$engine = Join-Path $solutionRoot 'engine\Check-PIM-Groups-IsRoleAssignable\Check-PIM-Groups-IsRoleAssignable.ps1'
if (-not (Test-Path -LiteralPath $engine)) { throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\Check-PIM-Groups-IsRoleAssignable\Check-PIM-Groups-IsRoleAssignable.ps1." }
& $engine
