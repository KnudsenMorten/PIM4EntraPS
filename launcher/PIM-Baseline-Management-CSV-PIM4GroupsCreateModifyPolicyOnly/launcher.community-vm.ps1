...
<#
.SYNOPSIS
    Community VM launcher for PIM4EntraPS\PIM-Baseline-Management-CSV-PIM4GroupsCreateModifyPolicyOnly. Invokes the engine
...
.DESCRIPTION
    Runs PIM4EntraPS\PIM-Baseline-Management-CSV-PIM4GroupsCreateModifyPolicyOnly on a Windows box in the customer's own tenant.
...
if (-not (Test-Path -LiteralPath $engine)) {
    throw "Launcher: engine script not found at $engine. Expected <solroot>\engine\PIM-Baseline-Management-CSV-PIM4GroupsCreateModifyPolicyOnly\PIM-Baseline-Management-CSV-PIM4GroupsCreateModifyPolicyOnly.ps1."
}
& $engine
