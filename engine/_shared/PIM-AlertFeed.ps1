...
$script:PimAlertFeedEventCatalog = @('engine-failure','drift','expiring-access','break-glass','coverage','target-missing','pending-uncommitted')   # 'coverage': REQ-I + REQ-U; 'target-missing': §79.1
