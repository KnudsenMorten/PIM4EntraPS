<#
.SYNOPSIS
    PIM-Baseline-Management-CSV-EntraIDRolesOnly - engine script in the PIM4EntraPS solution.

.NOTES
    Solution       : PIM4EntraPS
    File           : PIM-Baseline-Management-CSV-EntraIDRolesOnly.ps1
...
#####################################################################################################################################
# Step 1/3: Detect delta (changes) between files $GroupRoleAssignmentsFile_LastApplied and $GroupRoleAssignmentsFile
#####################################################################################################################################

    # Define the paths to the CSV files
    $csv1Path     = $global:GroupRoleAssignmentsFile_LastApplied
    $csv2Path     = $global:GroupRoleAssignmentsFile
    $deltaCsvPath = $global:GroupRoleAssignmentsFile_Delta
...
#####################################################################################################################################
# Step 2/3: Process only delta (changes) | Assignment of Roles by Groups
#####################################################################################################################################

    If ($DeltaFound) {
        Assign-Roles-Groups-From-file-CSV -GroupRoleAssignmentsFile $deltaCsvPath
    }
