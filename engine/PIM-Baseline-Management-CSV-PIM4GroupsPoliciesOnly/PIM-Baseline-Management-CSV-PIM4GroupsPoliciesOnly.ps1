<#
.SYNOPSIS
    PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly - engine script in the PIM4EntraPS solution.

.NOTES
    Solution       : PIM4EntraPS
    File           : PIM-Baseline-Management-CSV-PIM4GroupsPoliciesOnly.ps1
